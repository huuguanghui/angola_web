			...
			<div class="span6 offset3 tabbable tabs-left">
				...
				<div class="tab-content">	
                    <div class="tab-pane active" id="pane-user-info">
                        <h3>基本信息</h3>
                        <hr>
                        <form method="post" action="/angola/setting/changeNickname" class="im-form">
					...
					<div class="tab-pane" id="pane-change-password">
						<h3>修改密码</h3>
						<hr>
						<form action="/angola/setting/changepassword" method="post" id="formChangePwd" class="im-form" >
